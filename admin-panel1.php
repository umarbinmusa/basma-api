...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> BASMAH MEDICAL CLINICS</a>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Ultrasound scan" name="spec">Ultrasound Scan</option>
                      <option value="Maternity Clinics" name="spec">Maternity Clinics</option>
                      <option value="Operation Sevices" name="spec">Operation Services</option>
                    </select>
                    </div><br><br>
